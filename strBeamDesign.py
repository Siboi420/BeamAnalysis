...
if layering_required:
        ...
        yy_tension1= np.repeat((h-d), len(tension_bars_layer1)) if len(tension_bars_layer1) > 0 else []
        yy_tension2 = np.repeat((h-d - dl - 20), len(tension_bars_layer2)) if len(tension_bars_layer2) > 0 else [] #20 mm assumed here
